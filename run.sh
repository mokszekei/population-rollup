...
# python3.7 ./src/population-rollup.py ./input/censustract-00-10.csv ./output/report.csv
python3 src/population-rollup.py --input input/censustract-00-10.csv --output output/report.csv